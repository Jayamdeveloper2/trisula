...
$routes->get('index', 'Home::index', ['as' => 'index']);
$routes->get('about', 'Home::pageAbout', ['as' => 'about']);
$routes->get('services', 'Home::pageServices', ['as' => 'services']);
$routes->get('our-business-growth', 'Home::pageOurBusinessGrowth', ['as' => 'our-business-growth']);
$routes->get('gallery', 'Home::pageGallery', ['as' => 'gallery']);
$routes->get('contact', 'Home::pageContact', ['as' => 'contact']);
$routes->get('career', 'Home::pageCareer', ['as' => 'career']);
...
$routes->group(ADMIN_NAME, function ($routes) {
    ...
    $routes->get('homeourmission-manage', 'Admin\MainPage::pageHomeOurMission', ['as' => 'homeourmission-manage']);
    ...
    $routes->get('involved-manage', 'Admin\MainPage::pageCarrer', ['as' => 'involved-manage']);
