...
class Home extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->data['banner_data'] = $this->db->table('web_banner')
            ->select('*, CONCAT("' . BANNER_IMG . '", web_image) AS image,web_title,web_desc,web_link,web_btn_name')
            ->where('is_deleted', 0)
    ...
    public function pageOurBusinessGrowth()
    {
        ...
        return view('frontent/our-business-growth', $this->data);
    }
    ...
    public function pageCareer()
    {
        ...
        return view('frontent/career', $this->data);
    }
