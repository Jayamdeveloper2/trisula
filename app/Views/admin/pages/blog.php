        ...
        <div class="content-wrapper">
            ...
            <script>
                ...
                function deleteImage(imageUrl) {
                    ...
                    xhr.open('POST', '<?php echo base_url('manage-tools/delete-blog-content-image'); ?>', true);
                ...
                class MyUploadAdapter {
                    ...
                    _initRequest() {
                        ...
                        xhr.open('POST', '<?php echo base_url('manage-tools/upload-blog-content-image'); ?>', true);
