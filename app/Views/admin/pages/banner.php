                                                ...
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" name="web_title" class="form-control" placeholder="Enter banner title">
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <textarea name="web_desc" class="form-control" rows="3" placeholder="Enter banner description"></textarea>
                                                            </div>
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" name="web_link" class="form-control" placeholder="Enter button link (URL)">
                                                            </div>
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" name="web_btn_name" class="form-control" placeholder="Enter button name">
                                                            </div>
                                                            <div class="help-block"></div>
                                                        </div>
                                                    </div>
